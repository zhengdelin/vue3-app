...
function createI18nValidators() {
  ...
  return {
    sameAs: function <T extends object, K>(getTarget: (data: UnRefs<T>) => K, message?: (targetV: K, i18n: typeof $tt) => string) {
...
export function withI18nMessageValidator(validator: any, { property, args: i18nArgs = [] }: { property?: MessageKeys; args?: unknown[] }) {
