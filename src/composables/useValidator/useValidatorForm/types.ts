...
export interface UseValidatorFormField {
  ...
  label<T extends ValidatorFormFieldBasicProps>(props: T, keys: UseValidatorFormFieldKeyResult["modelKey"]): UseValidatorFormFieldLabelResult;
  config<T extends ValidatorFormFieldBasicProps>(props: T, keys: UseValidatorFormFieldKeyResult["modelKey"]): UseValidatorFormFieldConfigResult;
}
