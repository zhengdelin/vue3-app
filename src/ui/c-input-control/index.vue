<template>
  ...
  >
    <div v-if="isPrependedInner" class="prepend-inner" @click="onPrependInnerClick">
      <slot name="prepend-inner" v-bind="inputControlSlotProps"></slot>
    </div>
    <div class="input--field">
      <span v-if="label" class="label">{{ label }}</span>
      <slot v-bind="inputControlSlotProps"> </slot>
    </div>
    ...
    <div v-if="isAppendInnerSlotPassed" class="append-inner" @click="onAppendInnerClick">
      <slot name="append-inner" v-bind="inputControlSlotProps"></slot>
    </div>
  </div>
</template>

<script setup lang="ts">
import { createInputControlEmitEvents } from "./useInputControl";
...
const isFocus = ref(props.focus as boolean);
...
} = createInputControlEmitEvents(emit);

const inputControlSlotProps = computed(() => {
  return {
    onFocus: onFocus,
    onBlur: onBlur,
    focus: isFocus.value,
